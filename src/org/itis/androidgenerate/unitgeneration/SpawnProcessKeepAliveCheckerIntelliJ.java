...
public class SpawnProcessKeepAliveCheckerIntelliJ {
    ...
    public  SpawnProcessKeepAliveCheckerIntelliJ(){
    }


    public int startServer() throws IllegalStateException{
        System.out.println("SpawnProcessKeepAliveCheckerIntelliJ-startServer");
    ...
    public void stopServer(){
        ...
        System.out.println("SpawnProcessKeepAliveCheckerIntelliJ-stopServer");
        try {
            if(server != null) {
                server.close();
                server = null;
    ...
    private static class KeepAliveTask implements Runnable{
        ...
        public KeepAliveTask(Socket s){
            System.out.println("SpawnProcessKeepAliveCheckerIntelliJKeepAliveTask - Constructor");
            socket = s;
        }

        @Override
        public void run() {
            System.out.println("SpawnProcessKeepAliveCheckerIntelliJ-run");
            try {
